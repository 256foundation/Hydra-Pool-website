...
The initial release of Hydra Pool is being built in such a way that it supports long-term goals like alternative payout models such as echash, communicating with other Hydra Pool instances via [P2Poolv2](https://github.com/p2poolv2/p2poolv2), encrypted server/client communication, reduced bandwidth requirements, and a user-friendly interface that puts controls at the user's fingertips, and supports the ability for upstream pool proxying.
